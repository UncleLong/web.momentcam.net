...
function renderAddressDIV(address, isInsert) {
    var addressDiv = '<div class="box boxAddress active" id="' + address.AddrId + '">' +
                    '<div class="box-left">' +
                        '<span class="name" email="' + address.Email + '">' + address.ShipName + '</span>' +
                        '<span class="mobileNumber">' + address.RegionCode + " " + address.Mobile + '</span>' +
                        '<span class="address" zipCode="' + address.PostCode + '">' + address.AddrDetail + "," + address.AddrDetail1 + "," + address.CityName + "," + address.StateName + '</span>' +
                        '<span class="PostCode">' + address.PostCode + '</span>' +
                    '</div>' +
                    '<p class="country">' + address.countryName + '</p>' +
                    '<div class="default"></p>' +
                '</div>';
